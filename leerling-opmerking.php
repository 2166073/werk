    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="merk" value="<?php echo $Les['datum']; ?>" required readonly>
            </div>
            <div class="mb-3">
                <label class="form-label">ophaallocatie:</label>
                <input type="text" class="form-control" name="ophaallocatie" value="<?php echo $Les['ophaallocatie']; ?>" required readonly>
            </div>
            <div class="mb-3">
                <label class="form-label">leerling_opmerking:</label>
                <input type="text" class="form-control"  name="leerling_opmerking" value="<?php echo $Les['leerling_opmerking']; ?>" required >
            </div>
            <div class="mb-3">
                <label class="form-label">instructeur_opmerking:</label>
                <input type="text" class="form-control" name="instructeur_opmerking" value="<?php echo $Les['instructeur_opmerking']; ?>" required readonly>
            </div>
