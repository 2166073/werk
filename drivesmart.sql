...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 11 apr 2025 om 00:10
...
(1, '874289', 'mercedes', 'a klasse', 1, 0, NULL, 90),
...
(72, 'me@gmail.com', '$2y$10$IREkDqF8pmVzwf6GnoqstuhMqdgxepObsVW4fSmGHE2L4si6fEKRq', 'leerling'),
(73, 'gorav@gmail.com', '$2y$10$VGE9WplfNSvXYIM/dmkuE.m4wQlL9OyZ/ksRDCNxQ4KAMkbdPbkCe', 'instructeur'),
(74, 'hello@gmail.com', '$2y$10$4OiPQpOYVLkj9r9dogQbA.alFdf/yXx/k3uEYNsvGvma4MQ3bEVxy', 'leerling'),
(75, 'my@gmail.com', '$2y$10$NjMH7SyIENt7dhcWbEIaJezNi/t/OaWn25PbrmKL1mdVRQCxblULq', 'leerling'),
(76, 'no@gmail.com', '$2y$10$cgNVXHdqiAXE5s9AlXjed.4bCu/DS3A/XJEnCvWaDpIID5TzXuqzy', 'instructeur');
...
(5, 73, 'maandag', 'gorav', 2147483647, 'gorav@gmail.com'),
(6, 76, 'elke dag', 'no@gmail.com', 2147483647, 'no@gmail.com');
...
(7, 72, 'me', 'me', '2025-04-03', 'amsterdan', NULL),
(8, 74, 'hello', 'hello', '2025-04-01', 'hwsbkqj', NULL),
(9, 75, 'my', 'my', '2025-04-01', 'amsterdam', NULL);
...
(3, 3, 1, 1, '2025-04-10 00:00:00', 'yo', 0, NULL, NULL, 'ok', 0, '00:00:00', '00:00:00', 0),
...
(21, 4, 1, NULL, '2025-04-10 00:00:00', 'rotterdam', 0, NULL, NULL, 'ok', 2, '00:00:00', '00:00:00', NULL),
...
(27, 4, 1, NULL, '2025-04-10 00:00:00', 'rotterdam', 0, NULL, NULL, 'op', 1, '00:00:00', '00:00:00', NULL),
...
(45, 4, 3, 1, '2025-04-10 00:00:00', 'amsterdam', 0, NULL, 'niet', NULL, 0, '13:30:00', '14:30:00', 0),
(47, 4, 1, NULL, '2025-04-10 00:00:00', 'rotterdam', 0, NULL, NULL, 'nononono', 2, '12:00:00', '13:00:00', NULL),
(48, 6, 1, NULL, '2025-04-10 00:00:00', 'amsterdam', 0, NULL, NULL, 'nononono', 2, '14:00:00', '15:00:00', NULL),
(50, 6, 4, 1, '2025-04-10 00:00:00', 'nee', 0, NULL, 'nee\r\n', 'op', 0, '09:00:00', '10:00:00', 0),
(51, 6, 1, NULL, '2025-04-10 00:00:00', 'amsterdam', 0, NULL, NULL, 'check', 2, '08:00:00', '09:00:00', NULL),
(52, 6, 4, NULL, '2025-04-10 00:00:00', 'amsterdam', 0, NULL, NULL, 'check', 127, '13:48:00', '14:48:00', NULL),
(53, 6, 4, 1, '2025-04-10 00:00:00', 'rotterdam', 0, NULL, 'nee', 'jaaa', 2, '10:10:00', '11:11:00', NULL),
(54, 6, 4, 1, '2025-04-10 00:00:00', 'rotterdam', 0, NULL, 'yessss', 'nononono', 2, '10:10:00', '11:11:00', NULL),
(57, 8, 5, 1, '2025-04-10 00:00:00', 'amsterdam', 0, NULL, NULL, 'check', 2, '12:12:00', '13:13:00', NULL),
(60, 9, 6, NULL, '2025-04-10 23:56:09', 'Koppeling via dashboard', 0, NULL, NULL, NULL, 0, '00:00:00', '00:00:00', 0),
(61, 9, 6, 2, '2025-04-11 00:00:00', 'amsterdam', 0, NULL, 'op tijddd', 'nee', 0, '13:13:00', '14:14:00', 0);
...
(7, 71, 'ok', '2025-04-10'),
(8, 15, 'yayyy', '2025-04-10'),
(9, 1, 'hi', '2025-04-10'),
(10, 19, 'hiiiii', '2025-04-10'),
(11, 71, 'osman', '2025-04-10'),
(12, 75, 'goed', '2025-04-11'),
(13, 76, 'goed', '2025-04-11');
...
(14, 5, '2025-04-10', '09:00:00', '17:00:00', 0),
(15, 5, '2025-04-11', '09:00:00', '17:00:00', 0),
(16, 5, '2025-04-14', '09:00:00', '17:00:00', 0),
(17, 6, '2025-04-10', '09:00:00', '17:00:00', 0),
(18, 6, '2025-04-11', '09:00:00', '17:00:00', 0),
(19, 6, '2025-04-14', '09:00:00', '17:00:00', 0);
...
--
ALTER TABLE `gebruiker`
  MODIFY `gebruiker_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT voor een tabel `instructeur`
--
ALTER TABLE `instructeur`
  MODIFY `instructeur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `les`
  MODIFY `les_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
...
--
ALTER TABLE `mededeling`
  MODIFY `mededeling_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `verwijderd_les`
  MODIFY `verwijderd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
