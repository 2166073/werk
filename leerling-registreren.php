...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        // Leerling toevoegen
        $sql2 = "INSERT INTO leerling (gebruiker_id, naam, achternaam, geboortedatum, adres, telefoon) VALUES (?, ?, ?, ?, ?, ?)";
        $myDb->execute($sql2, [$gebruiker_id, $naam, $achternaam, $geboortedatum, $adres, $telefoon]);
...
<form method="POST" autocomplete="off">
    ...
    <div class="input-box">
        <textarea name="telefoon" placeholder="telefoon" required></textarea>
    </div>
